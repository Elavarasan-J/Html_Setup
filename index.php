...
?>
    <div id="fs-slider" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item wow fadeIn active">
                <img class="d-block w-100" src="assets/images/sliders/slider1.jpg" alt="Slider 1">
                <div class="carousel-content">
                    <div class="container">
                        <div class="carousel-content__inner">
                            <h2 class="mb-10 mb-md-20 mb-lg-30 wow fadeInUp" data-wow-duration="1s">Award Winning Salon & Spa</h2>
                            <div class="carousel-content__action pt-20">
                                <a href="#" class="btn btn-light-2 hvr-sweep-to-right wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">View Services</a>
                                <a href="#" class="btn btn-light-2 hvr-sweep-to-right ml-20 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.7s">Book an appointment</a>
                            </div>
                        </div>
                    </div>
                </div>
           ...
           <!--  <div class="carousel-item">
                <img class="d-block w-100" src="assets/images/sliders/slider2.jpg" alt="Slider 2">
                <div class="carousel-content">
                    <div class="container">
                        <div class="carousel-content__inner">
                            <h2 class="mb-10 mb-md-20 mb-lg-30">DePasquale Bridal</h2>
                            <div class="carousel-content__action pt-20">
                                <a href="#" class="btn btn-light-2 hvr-sweep-to-right">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <ol class="carousel-indicators mb-30 mb-lg-40">
            <li data-target="#fs-slider" data-slide-to="0" class="active"></li>
            <!-- <li data-target="#fs-slider" data-slide-to="1"></li> --> 
        </ol>
        
        <!-- Controls -->
        <a class="carousel-control carousel-control-prev" href="#fs-slider" role="button" data-slide="prev"><i class="icofont-thin-left"></i></a>
        <a class="carousel-control carousel-control-next" href="#fs-slider" role="button" data-slide="next"><i class="icofont-thin-right"></i></a>
    </div>
